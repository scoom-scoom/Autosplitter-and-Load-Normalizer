...
class ScreenScanner(ImageScanner):
    ...
    def __init__(self, settings):
        ...
        self.black_screen_start_time = 0
    ...
    # The screen scanner does not crop the frame.
