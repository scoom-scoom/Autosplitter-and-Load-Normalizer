...
startup {
		...
		settings.SetToolTip("SplitOnBolt", "WARNING: This feature has not been tested in a full run, use at your own risk. Set this to true if you want to split on each bolt (the split happens after the bolt collection animation is finished, due to current technical limitations).");
...
init {
    ...
    vars.titBoltCount = new MemoryWatcher<uint>(ptr + 0x80CF8);
